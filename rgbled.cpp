...
{
  ledStrip.setPixelColor(0, WS2812::RGB(125,125,125));
  ledStrip.setPixelColor(1, WS2812::RGB(125,125,125));
  ledStrip.setPixelColor(2, WS2812::RGB(125,125,125));
  ledStrip.setPixelColor(3, WS2812::RGB(125,125,125));
  ledStrip.setPixelColor(4, WS2812::RGB(125,125,125));

  ledStrip.setPixelColor(5, WS2812::RGB(0,125,0));
  ledStrip.setPixelColor(6, WS2812::RGB(0,125,0));
  ledStrip.setPixelColor(7, WS2812::RGB(0,125,0));
  ledStrip.setPixelColor(8, WS2812::RGB(0,125,0));
  ledStrip.setPixelColor(9, WS2812::RGB(0,125,0));

  ledStrip.setPixelColor(10, WS2812::RGB(125,0,0));
  ledStrip.setPixelColor(11, WS2812::RGB(125,0,0));
  ledStrip.setPixelColor(12, WS2812::RGB(125,0,0));
  ledStrip.setPixelColor(13, WS2812::RGB(125,0,0));
  ledStrip.setPixelColor(14, WS2812::RGB(125,0,0));

  ledStrip.setPixelColor(15, WS2812::RGB(0,125,0));
  ledStrip.setPixelColor(16, WS2812::RGB(0,125,0));
  ledStrip.setPixelColor(17, WS2812::RGB(0,125,0));
  ledStrip.setPixelColor(18, WS2812::RGB(0,125,0));
  ledStrip.setPixelColor(19, WS2812::RGB(0,125,0));
  ledStrip.show();
}
